...
import com.cab.management.controllers.CabsController;
import com.cab.management.controllers.RidersController;
...
import com.cab.management.exceptions.*;
import com.cab.management.strategies.*;
...
public class RunnerTest {
  ...
  void setUp() {
    ...
    CabMatchingStrategy cabMatchingStrategy = new IdleTimeCabMatchingStrategy();
    PricingStrategy pricingStrategy = new DefaultPricingStrategy();

    TripsManager tripsManager = TripsManager.builder().cabsManager(cabsManager)
            .cabMatchingStrategy(cabMatchingStrategy)
            .pricingStrategy(pricingStrategy).build();
